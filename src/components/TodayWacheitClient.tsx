    ...
    <div className="relative" ref={containerRef}>
      ...
      >
        ...
        <a 
          ...
          className="w-auto pr-4 sm:pr-5 border-r border-zinc-200 dark:border-zinc-800/80 flex flex-col items-center justify-center gap-3 shrink-0 group hover:opacity-90 transition-opacity"
        >
          <div className="w-[56px] h-[56px] sm:w-[64px] sm:h-[64px] border-2 border-zinc-200 dark:border-[#3a3a3a] p-1.5 overflow-hidden bg-zinc-50 dark:bg-[#242424] shadow-[4px_4px_0_0_rgba(0,0,0,0.1)] dark:shadow-[4px_4px_0_0_rgba(0,0,0,1)]">
            <Image 
          ...
          <div className="flex items-center gap-1.5 mt-1">
            ...
            <svg className="w-3.5 h-3.5 text-zinc-500 dark:text-gray-400 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
