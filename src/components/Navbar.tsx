...
export default function Navbar() {
  return (
    <nav className="animate-fade-in-up sticky top-0 z-50 w-full flex items-center justify-center bg-white/70 dark:bg-[#100F0F]/70 backdrop-blur-xl py-4 sm:py-5 mb-0 sm:mb-2 transition-colors duration-300">
